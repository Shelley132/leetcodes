...
public class Dijkstras {
	...
	public static void main(String[] args) {
		...
		g.addVertexs('D', Arrays.asList(new Vertexs('F', 8)));
		g.addVertexs('E', Arrays.asList(new Vertexs('H', 1)));
...
class Graphs {
	...
	public List<Character> getShortestPath(Character start, Character finish) {
		...
		final Map<Character, Vertexs> previous = new HashMap<Character, Vertexs>();
